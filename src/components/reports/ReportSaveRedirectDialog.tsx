...
export function ReportSaveRedirectDialog({
  open,
  onClose,
  onGoStudentDetail,
  onGoStudentsList,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="report-save-redirect-title"
    >
      <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-5 shadow-xl">
        <h2 id="report-save-redirect-title" className="text-base font-semibold text-slate-900">
          저장되었습니다
        </h2>
